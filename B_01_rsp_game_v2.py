...
while rounds_played < num_rounds:
    ...
    #If user choice exit code break loop
    if user_choice == "xxx":
        break

    result = rps_compare(user_choice, comp_choice)

    #Adjust game lost / game tied counters and add results of game history
    if result == "tie":
        rounds_tied += 1
        feedback = "You've tied"


    elif result == "lose":
        rounds_lost += 1
        feedback = f"{username} I'm afraid you've lost"

    else:
        feedback = f"{username} you've won."
...
if rounds_played > 0:
    ...
    if see_history == "yes" or see_history == "y":
